      ...
      switch (_a.label) {
        case 0:
          ...
          return [
            ...
            fetch(
              ""
                .concat(GEO_URL, "/direct?q=")
                .concat(query, "&limit=5&appid=")
                .concat(API_KEY)
            ),
          ];
        case 1:
      ...
      switch (_a.label) {
        case 0:
          ...
          return [
            ...
            fetch(
              ""
                .concat(BASE_URL, "/weather?q=")
                .concat(cityName, "&appid=")
                .concat(API_KEY, "&units=metric&lang=hu")
            ),
          ];
        case 1:
          response = _a.sent();
      ...
      switch (_a.label) {
        case 0:
          ...
          return [
            ...
            fetch(
              ""
                .concat(BASE_URL, "/air_pollution?lat=")
                .concat(lat, "&lon=")
                .concat(lon, "&appid=")
                .concat(API_KEY)
            ),
...
function displayAirQuality(airData) {
  ...
  airCard.innerHTML =
    '\n    <div class="card-body">\n      <h6 class="card-title">Air Quality</h6>\n      <div class="row">\n        <div class="col-6">\n          <div class="aqi-display">\n            <span class="aqi-value aqi-'
      .concat(aqi, '">')
      .concat(
        aqi,
...
function displaySevenDayForecast(forecastData) {
  ...
  var sevenDayHTML =
    '\n    <div class="card-body">\n      <h6 class="card-title text-center mb-3">7 Day Forecast</h6>\n      <div class="daily-forecast-container">\n  ';
  dailyData.slice(0, 7).forEach(function (day) {
    var date = new Date(day.dt * 1000);
    var dayName = date.toLocaleDateString("hu-HU", { weekday: "short" });
